        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <div className="space-y-6 text-gray-400 font-light leading-relaxed">
              ...
              <p>
                <strong className="text-gold-400 font-normal">Bilal Çayır</strong> liderliğinde, detaylara verdiğimiz önem ve profesyonel ekibimizle, düğün, nişan, söz ve tüm özel davetlerinizi sıradanlıktan uzak, tamamen size özel bir estetikle tasarlıyor ve hayata geçiriyoruz.
              </p>
              <p>
